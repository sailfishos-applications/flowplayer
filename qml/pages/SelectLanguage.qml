...
Dialog {
    ...
    onStatusChanged: {
        if (status === PageStatus.Activating) {
            selValue = utils.readSettings("Language", "en")
        }

    }

    property string prevValue
    property string selValue: "en"
    property string selValueName: "English"

    onAccepted: {
        utils.setSettings("Language", selValue)
        utils.setSettings("LanguageName", selValueName)
    ...
    ListModel {
        ...
        ListElement { name: "Danish"; value: "da" }
